...
'LIBID:{420B2830-E718-11CF-893D-00A0C9054228}
    ...
    'Major.Minor:1.0
        'CLSID:{0D43FE01-F093-11CF-8940-00A0C9054228}
        'ProgID:Scripting.FileSystemObject
Public Function GetSearchFileCount(ByVal searchFilePath As String, ByVal searchName As String, Optional ByVal enFileNameType As EnumFileNameType, Optional ByVal ignoreCase As Boolean) As Long
On Error GoTo Err
