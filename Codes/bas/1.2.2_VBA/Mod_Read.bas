...
'LIBID:{420B2830-E718-11CF-893D-00A0C9054228}
    ...
    'Major.Minor:1.0
        'CLSID:{0D43FE01-F093-11CF-8940-00A0C9054228}
        'ProgID:Scripting.FileSystemObject
Public Function GetSelectFileSpec(ByVal filePath As String, Optional ByVal filterDescriptions As String, Optional ByVal filterExtensions As String, _
                                  Optional ByVal multiSelect As Boolean, Optional ByVal dialogTitle As String, Optional ByVal filterSeparateFLG As Boolean) As String()
On Error GoTo Err
